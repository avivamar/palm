...
import { ShimmerButton, AnimatedBeam, SparklesText, OrbitingCircles, Ripple, Meteors } from '../components';
import { Card } from '../components/card';
export const AnimationShowcase = () => {
    const containerRef = useRef(null);
    const div1Ref = useRef(null);
    const div2Ref = useRef(null);
    return (<div className="min-h-screen bg-black p-8 space-y-16">
      ...
      <Card className="p-8 bg-gray-900 text-center">
        ...
        <div className="space-y-4">
          <SparklesText text="✨ Magical Text Effect ✨" className="text-3xl text-white" colors={{ first: '#9FE2BF', second: '#FFBF9F' }} sparklesCount={15}/>
          <SparklesText text="Premium Experience" className="text-xl text-purple-300" colors={{ first: '#A855F7', second: '#EC4899' }} sparklesCount={8}/>
        </div>
      </Card>
      ...
      <Card className="p-8 bg-gray-900 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <ShimmerButton shimmerColor="#ffffff" background="linear-gradient(45deg, #6366f1, #8b5cf6)" className="text-white">
            Get Started
          </ShimmerButton>
          
          <ShimmerButton shimmerColor="#fbbf24" background="linear-gradient(45deg, #f59e0b, #d97706)" className="text-white" shimmerDuration="2s">
            Premium Plan
          </ShimmerButton>
          
          <ShimmerButton shimmerColor="#10b981" background="linear-gradient(45deg, #059669, #047857)" className="text-white" borderRadius="12px">
            Success Action
          </ShimmerButton>
        </div>
      </Card>
      ...
      <Card className="p-8 bg-gray-900">
        ...
        <div ref={containerRef} className="relative h-64 w-full border border-gray-700 rounded-lg overflow-hidden">
          
          <div ref={div1Ref} className="absolute top-12 left-12 w-16 h-16 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full flex items-center justify-center">
            <span className="text-white font-bold">A</span>
          </div>
          
          
          <div ref={div2Ref} className="absolute bottom-12 right-12 w-16 h-16 bg-gradient-to-r from-blue-500 to-green-500 rounded-full flex items-center justify-center">
            <span className="text-white font-bold">B</span>
          </div>
          
          <AnimatedBeam containerRef={containerRef} fromRef={div1Ref} toRef={div2Ref} curvature={50} gradientStartColor="#a855f7" gradientStopColor="#06b6d4" duration={3}/>
        </div>
      </Card>
      ...
      <Card className="p-8 bg-gray-900">
        ...
        <div className="relative h-64 w-full flex items-center justify-center">
          <div className="relative w-48 h-48 bg-gradient-to-r from-purple-600 to-blue-600 rounded-full flex items-center justify-center">
            ...
            <Ripple mainCircleSize={100} mainCircleOpacity={0.15} numCircles={6} className="text-purple-300"/>
          </div>
        </div>
      </Card>
...
//# sourceMappingURL=animation-showcase.jsx.map