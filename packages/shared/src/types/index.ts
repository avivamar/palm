...
// User role types (from existing system)
export type UserRole = 'customer' | 'admin' | 'beta_tester';

// Locale types (from existing i18n system)
...
// Module state types for admin package
...
// Contract types for package communication
...
// Enhanced business types for better type safety
export type Product = {
  id: string;
  name: string;
  description?: string;
...
// Enhanced API types for better error handling
...
// Component state types for better state management
