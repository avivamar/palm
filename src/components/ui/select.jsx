...
function SelectTrigger(_a) {
  const { className, size = 'default', children } = _a; const props = __rest(_a, ['className', 'size', 'children']);
  return (
...
function SelectContent(_a) {
  const { className, children, position = 'popper' } = _a; const props = __rest(_a, ['className', 'children', 'position']);
  return (
...
function SelectItem(_a) {
  const { className, children } = _a; const props = __rest(_a, ['className', 'children']);
  return (
