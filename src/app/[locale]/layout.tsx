...
export const metadata: Metadata = {
  title: {
    ...
    default: 'Thepalmistrylife - Your Professional Palm Reading Service',
  },
  description: 'Thepalmistrylife is a professional palmistry platform that combines traditional palm reading wisdom with modern technology to provide accurate palm analysis and life guidance.',
  metadataBase: new URL(process.env.SITE_URL || 'https://www.thepalmistrylife.com'),
  applicationName: 'Thepalmistrylife',
  authors: [{ name: 'Thepalmistrylife Team', url: 'https://www.thepalmistrylife.com/about' }],
  generator: 'Next.js',
  keywords: ['palmistry', 'palm reading', 'hand analysis', 'life guidance', 'fortune telling'],
  referrer: 'origin-when-cross-origin',
  creator: 'Thepalmistrylife',
  publisher: 'Thepalmistrylife',
  formatDetection: {
    email: false,
    address: false,
    telephone: false,
  ...
  openGraph: {
    ...
    title: 'Thepalmistrylife - Your Professional Palm Reading Service',
    description: 'Thepalmistrylife is a professional palmistry platform that combines traditional palm reading wisdom with modern technology to provide accurate palm analysis and life guidance.',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Thepalmistrylife Palm Reading Service',
      },
    ],
  },
  twitter: {
